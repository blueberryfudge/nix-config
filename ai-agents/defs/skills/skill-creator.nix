{
  ...
  content = ''
    ...
    Default assumption: Claude is already very smart. Only add context Claude does not already have. Challenge each piece of information: "Does Claude really need this explanation?" and "Does this paragraph justify its token cost?"
    ...
    - Benefits: Keeps SKILL.md lean, loaded only when Claude determines it is needed
